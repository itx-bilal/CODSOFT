      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              SizedBox(height: 10,),
              Text('Add Income',style: TextStyle(color: Colors.teal,fontSize: 25),),
              SizedBox(height: 40,),
              Container(
                ...
                child: Form(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      filled: true,
                      fillColor: Color(0xffEDF7F6),
                      prefixIcon: Icon(Icons.trending_down,color: Colors.teal,),
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () async{
                      if(_categorykey.currentState!.validate() && _amountkey.currentState!.validate()&&_Datekey.currentState!.validate()&&_descriptionkey.currentState!.validate()) {
                        ...
                        await FirebaseFirestore.instance.collection('user_incomes').doc(user?.uid).collection('incomes').add({
                          'Category': 'income',
