...
class EditIncomeScreen extends StatefulWidget {
  ...
  EditIncomeScreen({required this.details});
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Edit Income',style: TextStyle(color: Colors.white,),),
      ),
            ...
            children: [
              Hero(
                ...
                child: Container(
                  ...
                  child: Icon(Icons.trending_down,color: Colors.white,size: 30,),
                ),
              ),
              SizedBox(height: 10,),
              Text('Edit Income',style: TextStyle(color: Colors.teal,fontSize: 25),),
              SizedBox(height: 40,),
              Container(
