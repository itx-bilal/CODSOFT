    ...
    return Dialog(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Center(
              child: Lottie.asset('assets/animations/images_required_animation.json'),
            ),
            Center(child: Text('$heading',style: TextStyle(fontSize: 20,color: Colors.orange,fontWeight: FontWeight.bold),)),
            SizedBox(height: 5,),
            ...
            Container(
              ...
              child: ElevatedButton(
                  ...
                  }, child: Text('Okay',style: TextStyle(color:Color(0xFF0E234F),),)),
            )
          ],
        ),
      ),
