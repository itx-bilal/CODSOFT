                      ...
                      child: Container(
                        ...
                        child: Form(
                          child: TextFormField(
                            ...
                            cursorColor: Color(0xFF0E234F),
                            style: TextStyle(color: Color(0xFF0E234F)),
                            decoration: InputDecoration(
                              prefixIcon: Icon(Icons.search,color: Color(0xFF0E234F),),
                              focusedBorder: InputBorder.none,
                              enabledBorder: InputBorder.none,
                              fillColor: Colors.white,
                              filled: true,
                              hintText: 'Search Recipe',
                              hintStyle: TextStyle(color: Color(0xFF0E234F,)),
        ...
        Expanded(
                  child: ListView.separated(
                      itemBuilder: (context,index) {
                        String name_position = foodName[index];
                        ...
                        else if(name_position.toLowerCase().contains(searchController.text)||name_position.toUpperCase().contains(searchController.text)||name_position.contains(searchController.text)) {
                          return GestureDetector(
                            onTap: () {
                              _navigateToDetailScreen(index);
                            },
                      ...
                      separatorBuilder: (context, _) {
                        return SizedBox(height: searchController.text.isEmpty ? 16 : 3);
                      },
